...
pub mod spacing {
    pub const XSMALL: f32 = 4.;
    pub const SMALL: f32 = 8.;
    pub const MEDIUM: f32 = 16.;
    pub const LARGE: f32 = 32.;
    pub const XLARGE: f32 = 64.;
}

pub mod text_size {
    pub const XSMALL: f32 = 14.;
    pub const SMALL: f32 = 16.;
    pub const MEDIUM: f32 = 20.;
    pub const LARGE: f32 = 24.;
    pub const XLARGE: f32 = 28.;
}
